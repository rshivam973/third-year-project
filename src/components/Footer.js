...
function Footer() {
  ...
  <footer className="d-flex flex-wrap align-items-center py-2">
    <p className="col-md-4 mb-0 text-light flex-fill">&copy; @2022</p>


    <div className="nav col-md-5 d-inline-flex flex-fill align-items-center justify-content-center link-light text-decoration-none">
